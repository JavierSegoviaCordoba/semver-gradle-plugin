...
public val String.isDev: Boolean
    get() = lowercase().contains(SpecialStage.dev)
...
public val String.isRC: Boolean
    get() = lowercase().contains(SpecialStage.rc)
...
public val String.isSnapshot: Boolean
    get() = lowercase().contains(SpecialStage.snapshot)
