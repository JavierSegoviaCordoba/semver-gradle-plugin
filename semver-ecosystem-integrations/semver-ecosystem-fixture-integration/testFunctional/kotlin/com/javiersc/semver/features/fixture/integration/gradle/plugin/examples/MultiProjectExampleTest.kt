package com.javiersc.semver.features.fixture.integration.gradle.plugin.examples
...
private fun GradleRunner.projectDirByName(name: String): File =
    projectDir
        .walkTopDown()
        .first { it.isBuildGradleDcl && it.parentFile.isDirectory && it.parentFile.name == name }
        .parentFile

private val File.isBuildGradleDcl: Boolean
    get() = isFile && name == "build.gradle.dcl"
